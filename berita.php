...
// QUERY DATABASE: Mengambil semua berita diurutkan dari yang terbaru (tanggal DESC)
$query = mysqli_query($conn, "SELECT * FROM berita ORDER BY tanggal DESC, id DESC");
?>
...
<head>
    ...
    <title>Berita & Artikel - Jembatan Ilmu Store</title>
...
<div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-200 px-4 py-2 text-center">
    ...
    <main class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="mb-8 border-b pb-4">
            <h1 class="text-3xl font-bold text-primary text-center">Jendela Informasi</h1>
            <p class="text-gray-500 mt-1 text-center">Artikel terbaru seputar pendidikan, buku, dan gaya hidup.</p>
        </div>
            ...
            ?>
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition duration-300 flex flex-col h-full">
                    <div class="h-48 overflow-hidden relative">
                        <img src="<?php echo $berita['thumbnail']; ?>" alt="<?php echo $berita['judul']; ?>" 
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <div class="text-xs text-gray-400 mb-2 flex items-center gap-2">
                            <i class="fa-regular fa-calendar"></i> <?php echo date('d M Y', strtotime($berita['tanggal'])); ?>
                            <span>|</span>
                            <i class="fa-regular fa-user"></i> <?php echo $berita['penulis']; ?>
                        </div>
                        
                        <h3 class="font-bold text-xl mb-3 text-gray-800 hover:text-primary transition line-clamp-2">
                            <a href="detail_berita.php?id=<?php echo $berita['id']; ?>"><?php echo $berita['judul']; ?></a>
                        </h3>
                        
                        <p class="text-gray-600 text-sm mb-4 line-clamp-3">
                            <?php echo $berita['isi_singkat']; ?>
                        </p>

                        <div class="mt-auto">
                            <a href="detail_berita.php?id=<?php echo $berita['id']; ?>" class="inline-block text-primary font-bold hover:underline">
